...
db_foreach righello "" {
	...
	append righello "<td><a href=\"test-sessione?esame_id=${esame_id}&rispusr_id=${rispusr_id}\"><b><big><center><span class=\"label label-success\">${conta}</span></center></big></b></a></td>"
    }
    incr conta
}
append righello "</tr></table>"
